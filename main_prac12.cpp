...
void animacion()
{
	...
	if (g_fanimacion)
	{
		...
		if (movKit2==false && movKit > -60 && movy==4)
		{
			movKit -= 0.5;
			giro_llanta += 10.0;
			if (movKit == -60)
		...
		if (movKit2 == true && movKit == -60 && movy < 31)
		{
			movy += 0.5;
			girod = 90.0;

		}
		if (movKit2==true && movKit <= 60 && movy==30)
		{
			movKit += 0.5;
			if (movKit == 60)
				movKit2 = false;
		...
		if (movKit2==true && movKit<= 60 && movy==4)
		{
			movKit -= 0.5;
			girod = 0.0;
			giro_llanta += 10.0;
