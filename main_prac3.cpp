//Semestre 2019 - 2
 ...
 Reporte 3
 Manual
 Se modifico la funcion prisma para que permita tres valores flotantes para x, y y z, despues se agregaron en la posición de los vertices
 y dividirlo entre dos, en base a eso pude modificar para realizar el pixel art en 3D, moverse con las teclas w,a,s,d,q y e para apreciar
 la figura completa
 */
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	glClearColor(0.3f, 0.0f, 1.0f, 0.0f);				// Negro de fondo
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("Reporte 3"); // Nombre de la Ventana
